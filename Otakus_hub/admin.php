...
<br><br><br><br><br><br>
<div class="middle" style="  padding:40px; border:1px solid #00ffff; margin:0px auto; width:400px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#000000;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" id="home-tab" data-toggle="tab" href="#login" role="tab" aria-controls="home" aria-selected="true">Home</a>
              ...
              <a class="nav-link" id="profile-tab" style="color:cyan;"    aria-controls="profile" aria-selected="false">Welcome Admin</a>
