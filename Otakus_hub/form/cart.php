...
<div class="middle" style="  padding:60px; border:1px solid #000000;  width:100%;">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#000000;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#00ffff;" id="viewitem-tab" data-toggle="tab" href="#viewitem" role="tab" aria-controls="viewitem" aria-selected="true">View Cart</a>
          </li>
          <li class="nav-item">
                 ...
                 <table class="table">
                  <tbody>
	               <?php
	                ...
	                ?>
                      <tr>
                         <td><image src="../image/merchant/<?php echo $em."/goodimages/".$res['fldimage'];?>" height="80px" width="100px"></td>
                         <td><?php echo $res['goodname'];?></td>
                   ...
                   <?php
	                 ...
	                 ?>
					 <tr><button type="button" class="btn btn-outline-success"><a href="../index.php" style="color:green; text-decoration:none;">Your order has been placed Shop more! </a></button></tr>
