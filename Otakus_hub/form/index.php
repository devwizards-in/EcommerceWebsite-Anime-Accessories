...
<div class="middle" style=" margin:0px auto;width:500px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#000000;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#00ffff;" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">Log In</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" id="signup-tab" style="color:#00ffff;" data-toggle="tab" href="#signup" role="tab" aria-controls="signup" aria-selected="false">Create New Account</a>
          </li>
       </ul>
	   <br><br>
	   ...
	   <!--login Section-- starts-->
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  ...
			  <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="login" style="background:#000000; border:1px solid #00ffff;" class="btn btn-primary">Login</button>
