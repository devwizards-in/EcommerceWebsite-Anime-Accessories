...
<div class="container">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#000000;border-radius:10px 10px 10px 10px;" role="tablist">
          ...
          <li class="nav-item">
              <a class="nav-link"  style="color:#00ffff;" id="manageaccount-tab" data-toggle="tab" href="#manageaccount" role="tab" aria-controls="manageaccount" aria-selected="false">Account Settings</a>
          </li>
		  <li class="nav-item">
              <a class="nav-link" style="color:#00ffff;"  id="ManageVendors-tab" data-toggle="tab" href="#ManageVendors" role="tab" aria-controls="ManageVendors" aria-selected="false">Manage Vendors</a>
          </li>
		  <li class="nav-item">
              <a class="nav-link" style="color:#00ffff;" id="orderstatus-tab" data-toggle="tab" href="#orderstatus" role="tab" aria-controls="orderstatus" aria-selected="false">Order status</a>
          </li>
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/merchant/<?php echo $row['fld_email']."/goodimages/" .$row['fldimage'];?>" height="50px" width="100px">
						<br><?php echo $row['goodname'];?>
						</td>
						...
						<form method="post">
                        <td><a href=""><button type="submit" value="<?php echo $row['good_id']; ?>" name="delete"  class="btn btn-danger">Remove </button></td>
                        </form>
                   </tr>
		<?php
		}
...
<!--tab 1 ends-->	   
            ...
            <div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="manageaccount-tab">
			    <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="update" style="background:#000000; border:1px solid #00ffff;" class="btn btn-primary">Update</button>
			 ...
			 <div class="tab-pane fade show" id="ManageVendors" role="tabpanel" aria-labelledby="ManageVendors-tab">
			    <div class="container">
                 ...
                 <thead>
                    <tr>
                        <th scope="col"></th>
                            <th scope="col">merchant Id/vendor Id</th>
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/merchant/<?php echo $row['fld_email']."/" .$row['fld_logo'];?>" height="50px" width="100px"></td>
                        <th scope="row"><?php echo $row['fldvendor_id'];?></th>
						<td><?php echo $row['fld_name'];?></td>
						...
						<form method="post">
                        <td><a href="#"  style="text-decoration:none; color:black;" onclick="delRecord(<?php echo $row['fldvendor_id']; ?>)"><button type="button" class="btn btn-danger">Remove Vendor</a></a></td>
                        </form>
                   </tr>
		<?php
		}
		?>		   
			 ...
			 <div class="tab-pane fade" id="orderstatus" role="tabpanel" aria-labelledby="orderstatus-tab">
			   ...
			   <td><a href="searchgood.php?good_id=<?php echo $rrr['fld_good_id']; ?>"><?php echo $rrr['fld_good_id']; ?></td>
