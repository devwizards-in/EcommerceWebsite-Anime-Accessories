      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="form/cart.php"><span style=" color:black; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:black;" id="cart"  class="badge badge-light"><?php if(isset($re)) { echo $re; }?></span></i></span></a>
...
<h1 style="color:white; text-align:center; text-transform:uppercase;">we do this</h1>
<h3 style="color:white; text-align:center; text-transform:uppercase;">for u bestofriendo.</h3>
<p style="color:white; text-align:center; font-size:25px;">Our team gathers information from every vendors on a regular basis to ensure our data is fresh. Our vast community of anime lovers share their reviews and photos, so you have all that you need to make an informed choice.</p>

<h3 style="color:white; text-align:center; text-transform:uppercase;">Building amazing experiences around anime lovers.</h3>
<p style="color:white; text-align:center; font-size:25px;">Starting with information for over 10k community (and counting) globally,mina arigato.</p>

<h3 style="color:white; text-align:center; text-transform:uppercase;">"THE HOLE IN ONE'S HEART GETS FILLED BY OTHERS AROUND YOU".</p>
</div>
